...
})({"gYUZj":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "de008d18af53f98f";
"use strict";
...
},{}],"6H4Ku":[function(require,module,exports,__globalThis) {
...
words.forEach((word, index)=>{
    ...
    if (index < words.length - 1) descriptionElement.appendChild(document.createTextNode(' '));
});
/* #################### Animation timeline ######################*/ (0, _gsap.gsap).fromTo('.title .char', {
    x: 0,
    y: "8rem",
    opacity: 0
}, {
...
(0, _gsap.gsap).fromTo(".title-underline", {
    width: 0
}, {
    width: "100%",
    duration: 1.5,
...
(0, _gsap.gsap).fromTo('.row1, .row2, .row3', {
    width: 0
}, {
    width: "100%",
    duration: 0.5,
...
(0, _gsap.gsap).fromTo('.col1, .col2, .col3', {
    height: 0
}, {
    height: "100%",
    duration: 0.5,
...
(0, _gsap.gsap).fromTo('.board-stone1, .board-stone2', {
    scale: 0
}, {
    scale: 1,
    duration: 0.5,
...
(0, _gsap.gsap).fromTo('.main-description .word', {
    x: 0,
    y: "3rem",
    opacity: 0
}, {
...
},{"gsap":"fPSuC"}],"fPSuC":[function(require,module,exports,__globalThis) {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gYUZj","6H4Ku"], "6H4Ku", "parcelRequire94c2")

//# sourceMappingURL=index.af53f98f.js.map
